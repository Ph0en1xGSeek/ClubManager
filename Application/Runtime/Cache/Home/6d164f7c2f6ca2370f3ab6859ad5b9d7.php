...
<header>
    ...
    <!--Navbar-->
    <nav class="navbar fixed-top navbar-toggleable-md navbar-dark">
        <!--<div class="container">-->
            ...
            <div class="collapse navbar-collapse" id="navbarNav1" aria-expanded="true">
                ...
                <ul class="navbar-nav ml-auto nav-flex-icons">
                    ...
                    <li class="nav-item avatar dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-user"></i></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="post-wrapper">
                    <!--Post data-->
                    <h1 class="h1-responsive">赵俊杰 <small class="text-muted">优秀的榜样</small></h1>
                    ...
                    <div class="view overlay hm-white-light z-depth-1-half">
                        <img src="/ClubManager/Public/img/IMG_20170104_214431.jpg" class="img-fluid " alt="">
                        <div class="mask">
                        </div>
                    </div>
...
<!-- JQuery -->
<script type="text/javascript" src="/ClubManager/Public/js/jquery-2.2.3.min.js"></script>
